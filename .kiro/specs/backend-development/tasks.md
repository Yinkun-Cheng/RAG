...
### 1.1 数据库设计与迁移
- [ ] 1.1.1 创建项目表迁移脚本（projects）
- [ ] 1.1.2 创建模块表迁移脚本（modules）
- [ ] 1.1.3 创建 PRD 文档表迁移脚本（prd_documents）
- [ ] 1.1.4 创建 PRD 版本表迁移脚本（prd_versions）
- [ ] 1.1.5 创建测试用例表迁移脚本（test_cases）
- [ ] 1.1.6 创建测试步骤表迁移脚本（test_steps）
- [ ] 1.1.7 创建测试步骤截图表迁移脚本（test_step_screenshots）
- [ ] 1.1.8 创建标签表迁移脚本（tags）
- [ ] 1.1.9 创建 PRD 标签关联表迁移脚本（prd_tags）
- [ ] 1.1.10 创建测试用例标签关联表迁移脚本（test_case_tags）
- [ ] 1.1.11 创建测试用例版本表迁移脚本（test_case_versions）

### 1.2 GORM 模型定义
- [ ] 1.2.1 定义 Project 模型
- [ ] 1.2.2 定义 Module 模型
- [ ] 1.2.3 定义 PRDDocument 模型
- [ ] 1.2.4 定义 PRDVersion 模型
- [ ] 1.2.5 定义 TestCase 模型
- [ ] 1.2.6 定义 TestStep 模型
- [ ] 1.2.7 定义 TestStepScreenshot 模型
- [ ] 1.2.8 定义 Tag 模型
- [ ] 1.2.9 定义模型关联关系

### 1.3 数据库连接与初始化
- [ ] 1.3.1 实现 PostgreSQL 连接池
- [ ] 1.3.2 实现数据库迁移执行器
- [ ] 1.3.3 实现数据库健康检查
- [ ] 1.3.4 添加数据库连接到配置文件
